...
const teamMembers: TeamMember[] = [
  ...
  {
    id: 6,
    name: "Margarita Del Rosario Ortiz Chávez",
    role: "Licenciada en Diseño Grafico Estartegico",
    image: "/images/team/member1.jpg", // Asegúrate de tener esta imagen
    description: "Diseñadora de páginas y herramientas gráficas estratégicas y estéticas",
    skills: ["Ilustrador", "Photoshop", "Figma", "After Effects"],
    socialLinks: {
      behance: "https://www.behance.net/margaritaortiz1",
      linkedin: "https://www.linkedin.com/in/margarita-ortiz-7690862a9/",
    }
  }
