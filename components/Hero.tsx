    ...
    <>
      <section id="hero" className="flex flex-col items-center justify-center h-screen text-white">
        ...
        >
            ...
            <motion.div
              ...
              animate={{
                background: isHovered 
                  ? "linear-gradient(to right, #841DAD, #541472)"
                  : "linear-gradient(to right, #541472, #841DAD)"
              }}
          ...
          {/* Efecto de brillo */}
          <motion.div
            className="absolute inset-0 -z-10 bg-gradient-to-r from-primary to-secondary rounded-lg blur-xl opacity-50"
            animate={{
      ...
      {isModalOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gradient-to-br from-[#000000] to-primary rounded-xl p-8 max-w-md w-full mx-4"
          ...
          >
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full py-4 px-6 bg-gradient-to-r from-primary to-secondary text-white rounded-lg flex items-center justify-center space-x-3 hover:opacity-90 transition-all duration-300 transform hover:scale-[1.02]"
              >
